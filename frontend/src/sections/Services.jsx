    ...
    <section id="services" ref={sectionRef} className="py-24 md:py-32 lg:py-48 relative overflow-hidden bg-background px-6 lg:px-20">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-24 md:mb-32">
            <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black mb-8 tracking-tighter uppercase whitespace-nowrap italic leading-tight text-white">
